		...
		<nav
			...
			<div
				...
				<a class="navbar-brand brand-logo" href="${pageContext.servletContext.contextPath }"><img
					...
					class="navbar-brand brand-logo-mini" href="${pageContext.servletContext.contextPath }"><img
					src="${pageContext.servletContext.contextPath }/assets/images/logo-mini.svg" alt="logo" /></a>
			</div>
			<div class="navbar-menu-wrapper d-flex align-items-stretch">
				<div class="search-field d-none d-md-block">
					<form class="d-flex align-items-center h-100" action="${pageContext.servletContext.contextPath }/goods/search" method="get">
						<div class="input-group">
							<div class="input-group-prepend bg-transparent">
								<i class="input-group-text border-0 mdi mdi-magnify"></i>
							</div>
							<input type="text" class="form-control bg-transparent border-0"
								placeholder="키워드를 검색하세요." name="keyword">
						</div>
					</form>
				</div>
					...
					<sec:authorize access="isAuthenticated()">
						<li class="nav-item nav-profile dropdown"><a
							...
							<div class="dropdown-menu navbar-dropdown"
								...
								<a class="dropdown-item" href="${pageContext.servletContext.contextPath }/basket/view"> <i
						...
						<div
							...
							<a class="dropdown-item preview-item">
								<div class="preview-thumbnail">
									<img src="${pageContext.servletContext.contextPath }/assets/images/faces/face4.jpg" alt="image"
										class="profile-pic">
								</div>
								<div
							...
							<a class="dropdown-item preview-item">
								<div class="preview-thumbnail">
									<img src="${pageContext.servletContext.contextPath }/assets/images/faces/face2.jpg" alt="image"
										class="profile-pic">
								</div>
								<div
									class="preview-item-content d-flex align-items-start flex-column justify-content-center">
							...
							<a class="dropdown-item preview-item">
								<div class="preview-thumbnail">
									<img src="${pageContext.servletContext.contextPath }/assets/images/faces/face3.jpg" alt="image"
										class="profile-pic">
								</div>
								<div
									class="preview-item-content d-flex align-items-start flex-column justify-content-center">
