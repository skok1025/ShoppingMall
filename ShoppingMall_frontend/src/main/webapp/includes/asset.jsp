...
<link rel="stylesheet"
	...
	id="bootstrap-css">
<link rel="stylesheet" href="${pageContext.servletContext.contextPath }/assets/css/slide/slide_item.css"> 
<link rel="stylesheet" href="${pageContext.servletContext.contextPath }/assets/css/style.css"> 
<%-- 
<script
	src="${pageContext.servletContext.contextPath }/js/jquery/jquery-3.4.1.min.js"></script> 
--%>
...
<%-- 
<script
	src="${pageContext.servletContext.contextPath }/js/bootstrap/bootstrap.min.js"></script>
	  --%>